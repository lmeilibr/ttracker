...
class GetPlayerCourseV2:
    def __init__(self, payload):
        self.player_course = DeckSubmitV3(payload)


class GetPlayerCoursesV2:
    def __init__(self, payload):
        self.player_courses = payload


class GetSeasonAndRankDetail:
    def __init__(self, payload):
        self.current_season = payload['currentSeason']
        self.limited_rank_info = payload['limitedRankInfo']
        self.constructed_rank_info = payload['constructedRankInfo']
...
class MatchCreated:
    def __init__(self, payload):
        ...
        self.opponent_pet_selection = payload.get('opponentPetSelection')
        ...
        self.opponent_commander_grp_ids = payload[
